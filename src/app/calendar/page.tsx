  ...
  return (
    <main className="min-h-screen bg-canvas">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        <section>
          <p className="text-sm font-semibold text-steel">Calendar</p>
          <h1 className="mt-2 text-3xl font-semibold tracking-normal text-ink">
            Catalysts, filings, and thesis checkpoints.
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted">
            ThesisLens treats calendar events as thesis pressure tests. Earnings, filings,
            press releases, and disclosures should map to specific questions.
          </p>
        </section>
